...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Set VAD Provider", Keywords = "Voice Activity Detector Engine"), Category = "Streaming Sound Wave|VAD")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get VAD Provider", Keywords = "Voice Activity Detector Provider"), Category = "Streaming Sound Wave|VAD")
	 ...
	 * This is only applicable to the default (libfvad) VAD. For other VAD implementations, this function has no effect
